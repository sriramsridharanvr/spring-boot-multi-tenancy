...
public class TenantConnectionProvider implements MultiTenantConnectionProvider {
	private static final long serialVersionUID = -5638443123778188527L;
	
	private static final Logger logger = LoggerFactory.getLogger(TenantConnectionProvider.class);

	private static final String DEFAULT_TENANT = "public";
	private static final String MULTI_TENANT_STRATEGY_SCHEMA = "schema";
	
	@Value("${multi-tenant-strategy:discriminator}")
	...
	public Connection getConnection(String tenantIdentifier) throws SQLException {
		...
		if(MULTI_TENANT_STRATEGY_SCHEMA.equalsIgnoreCase(multiTenantStrategy)) {
